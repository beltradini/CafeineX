...
1. `CafeineXApp` is the composition root. It opens `CafeineXSchemaV2` through `CafeineXMigrationPlan`, injects app-wide preference stores, and launches `AppShellView`.

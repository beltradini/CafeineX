...
2. `TodayView` owns dashboard presentation and observes a bounded 30-day SwiftData query.
3. `HistoryView` queries the complete retained local timeline and provides search, source filters, daily grouping, and aggregate totals.
